...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['contact-form-name'] != '' AND $_POST['contact-form-email'] != '' AND $_POST['contact-form-subject'] != '' ) {
        ...
        $toemail = 'spqr.x@hotmail.com'; // Your Email Address
        $toname = 'Savvy Initiative'; // Your Name
		...
		if( $botcheck == '' ) {
			...
			$ar_body = "Thank you for contacting us. Our Team will be in contact Shortly.<br><br>Regards,<br>Savvy Initiative.";
